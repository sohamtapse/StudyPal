...
const DashboardPage = () => {
  ...
  return (
    <div className="min-h-screen bg-black text-white flex flex-col items-center px-4 md:px-6 py-5 relative overflow-hidden">
      <div className="absolute -top-20 left-1/3 w-40 h-40 md:w-80 md:h-80 rounded-full bg-blue-500 opacity-30 blur-3xl animate-pop-blob"></div>
      <div className="absolute -top-10 right-1/3 w-40 h-40 md:w-80 md:h-80 rounded-full bg-purple-500 opacity-30 blur-3xl animate-pop-blob"></div>
        ...
        {!submitted && (
          <>
            ...
            >
              ...
              <p className="text-lg font-medium">Upload your study material</p>
