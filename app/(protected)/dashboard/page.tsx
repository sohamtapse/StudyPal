...
const DashboardPage = () => {
  ...
  const handleFileChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    if (e.target.files && e.target.files[0]) {
      ...
      setSubmitted(false); // reset if uploading new file
    }
  };
  ...
  return (
    <>
      <div className="min-h-screen bg-black text-white flex flex-col items-center px-4 md:px-6 py-5 relative overflow-hidden">
        <div className="absolute -top-20 left-1/3 w-50 h-50  rounded-full bg-blue-500 opacity-30 blur-3xl animate-pop-blob"></div>
        <div className="absolute -top-10 right-1/3 w-80 h-80  rounded-full bg-purple-500 opacity-30 blur-3xl animate-pop-blob"></div>
        ...
        <div className="w-full max-w-2xl relative z-10">
          ...
          {/* Show uploaded file info after submit */}
          {submitted && file && (
        ...
        <div className="mt-12 text-center w-full relative z-10">
          ...
          <div className="flex flex-col md:flex-row items-center justify-center gap-6">
            ...
            <div className="bg-gray-900/50 p-6 md:p-8 rounded-xl shadow-lg w-56 h-40 flex flex-col items-center justify-center hover:border hover:border-purple-400 transition-all duration-300 cursor-pointer hover:bg-gray-800/50 animate-pop-blob">
              ...
              <h3 className="font-semibold">PYQs</h3>
            ...
            <div className="bg-gray-900/50 p-6 md:p-8 rounded-xl shadow-lg w-56 h-40 flex flex-col items-center justify-center hover:border hover:border-purple-400 transition-all duration-300 cursor-pointer hover:bg-gray-800/50 animate-pop-blob">
              ...
              <h3 className="font-semibold">Semory</h3>
